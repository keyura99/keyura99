...
- **Databases**: MS SQL Server, Oracle PL/SQL, MySQL  

- **Languages**:  
  SQL (joins, window functions, stored procedures, indexing)  
  Python (Pandas, NumPy, automation)  

- **Data Engineering**:  
  Medallion Architecture (Bronze → Silver → Gold), ETL workflows, data modeling,  
